...
public class ListViewAlunosFotos extends ActionBarActivity {
    ...
    public void loadList(){
        ...
        alunos2GI.add(new Aluno(1, "Bruno Coimbra", R.drawable.bruno));
        alunos2GI.add(new Aluno(2, "Catalin Criste", R.drawable.cata));
        alunos2GI.add(new Aluno(3, "David Sousa", R.drawable.david));
        alunos2GI.add(new Aluno(6, "Joao Ventura", R.drawable.ventura));
        alunos2GI.add(new Aluno(7, "Jorge Silva", R.drawable.jorge));
        alunos2GI.add(new Aluno(8, "Marcelo Rachado", R.mipmap.ic_launcher));
        alunos2GI.add(new Aluno(9, "Mariana Costa", R.drawable.mariana));
        alunos2GI.add(new Aluno(10, "Patricia Carmo", R.drawable.paty));
        alunos2GI.add(new Aluno(11, "Ricardo Gomes", R.drawable.ricardo));
        alunos2GI.add(new Aluno(12, "Ruben Severino", R.drawable.ruben));
        alunos2GI.add(new Aluno(14, "Rui Ricardo", R.mipmap.ic_launcher));
        alunos2GI.add(new Aluno(15, "Samuel Santos", R.drawable.samuel));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewTurmas.setOnItemClickListener(parent, view, position, id) -> {

            //Compor uma string, com a posição activity para
            //Escrever um toast com um ID do item clicado
